           ...
           let myCopyOfSettings() =  //to je, co se ulozi
               {
                   ...
                   invCkbxLeft = (m.INVCheckBoxLeftIsChecked)
                   invCkbxLeftE = (m.INVCheckBoxLeftIsEnabled)  
                   invCkbxRight = (m.INVCheckBoxRightIsChecked)
                   ...
                   sgCkbx = (m.SGCheckBoxIsChecked)
                   sgCkbxE = (m.SGCheckBoxIsEnabled)
                   ...
                   karCkbxLeft = (m.KARCheckBoxLeftIsChecked)  
                   karCkbxLeftE = (m.KARCheckBoxLeftIsEnabled)  
                   karCkbxRight = (m.KARCheckBoxRightIsChecked)        
               }
           ...
           let myCopyOfModel() =  //to je, co se hned zobrazi
               {
                   ...
                   INVCheckBoxLeftIsChecked = (m.INVCheckBoxLeftIsChecked)
                   INVCheckBoxLeftIsEnabled = (m.INVCheckBoxLeftIsEnabled)
                   INVCheckBoxRightIsChecked = (m.INVCheckBoxRightIsChecked)
                   ...
                   SGCheckBoxIsChecked = (m.SGCheckBoxIsChecked)
                   SGCheckBoxIsEnabled = (m.SGCheckBoxIsEnabled)
                   ...
                   KARCheckBoxLeftIsChecked = (m.KARCheckBoxLeftIsChecked) 
                   KARCheckBoxLeftIsEnabled = (m.KARCheckBoxLeftIsEnabled) 
                   KARCheckBoxRightIsChecked = (m.KARCheckBoxRightIsChecked) 
